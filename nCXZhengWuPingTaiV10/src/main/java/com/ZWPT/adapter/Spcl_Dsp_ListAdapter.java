 ...
 * @date 2014-7-30
 */
public class Spcl_Dsp_ListAdapter extends BaseAdapter {

	private LayoutInflater inflater;
	private Context context = null;
	private List<Spcl_Dsp_List_Result> datas;
	private InfoFile_ infoFile_;

	public Spcl_Dsp_ListAdapter(Context context,
			List<Spcl_Dsp_List_Result> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.layout_spcl_dsp_list_item,
					null);
	...
	public List<Spcl_Dsp_List_Result> getHisInspectRecords() {
		return datas;
	}

	public void setNotifications(List<Spcl_Dsp_List_Result> datas) {
		this.datas = datas;
	}
