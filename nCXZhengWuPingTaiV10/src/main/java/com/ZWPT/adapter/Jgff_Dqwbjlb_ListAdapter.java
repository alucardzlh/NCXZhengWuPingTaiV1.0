 ...
 * @date 2014-7-30
 */
public class Jgff_Dqwbjlb_ListAdapter extends BaseAdapter {

	private LayoutInflater inflater;
	private Context context = null;
	private List<Jgff_Dqwbjlb_List_Result> datas;
	private InfoFile_ infoFile_;

	public Jgff_Dqwbjlb_ListAdapter(Context context,
			List<Jgff_Dqwbjlb_List_Result> datas) {
		this.datas = datas;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.layout_jgff_dqwbjlb_list_item, null);
			...
			holder.tvText_sjdjdd = (TextView) convertView
			...
			holder.tvText_chaoshi_date = (TextView) convertView
					.findViewById(R.id.tv_list_item_7);
		...
		holder.tvText_sjdjdd.setText(datas.get(position).getSldjdd());
		...
		holder.tvText_chaoshi_date.setText(datas.get(position)
				.getChaoshi_date() + "天");
	...
	class ViewHolder {
		...
		TextView tvText_sjdjdd;
		TextView tvText_shenqing_date;
		TextView tvText_fwsxname;
		TextView tvText_banjie_date;
		TextView tvText_chaoshi_date;
		Button btn_datail;
		boolean flag;
	}

	public List<Jgff_Dqwbjlb_List_Result> getHisInspectRecords() {
		return datas;
	}

	public void setNotifications(List<Jgff_Dqwbjlb_List_Result> datas) {
		this.datas = datas;
	}
