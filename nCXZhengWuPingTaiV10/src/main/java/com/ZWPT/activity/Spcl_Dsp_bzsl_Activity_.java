...
public final class Spcl_Dsp_bzsl_Activity_
    extends Spcl_Dsp_bzsl_Activity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.layout_spcl_dsp_bzsl);
    }
    ...
    private void afterSetContentView_() {
        ...
        edt_search_4 = ((TextView) findViewById(id.edt_search_4));
        edt_search_5 = ((TextView) findViewById(id.edt_search_5));
        ...
        edt_search_6 = ((TextView) findViewById(id.edt_search_6));
    ...
    public static Spcl_Dsp_bzsl_Activity_.IntentBuilder_ intent(Context context) {
        return new Spcl_Dsp_bzsl_Activity_.IntentBuilder_(context);
    }
    ...
    public static class IntentBuilder_ {
        ...
        public IntentBuilder_(Context context) {
            context_ = context;
            intent_ = new Intent(context, Spcl_Dsp_bzsl_Activity_.class);
        }
        ...
        public Spcl_Dsp_bzsl_Activity_.IntentBuilder_ flags(int flags) {
