...
public class NetWorkReceiver extends BroadcastReceiver {
	...
	private NetWorkReceiver(Context context) {
		...
		// ActivityApp.devMode =
		// Boolean.valueOf(context.getResources().getString(R.string.devMode));
	...
	public void initServer(ServerType serverType) {
		...
		// String payWs = props.getProperty("url_pay_ws", null);
		// String alipayNotify = props.getProperty("url_alipay_notify", null);
		// String bpnServer = props.getProperty("url_bpn_server", null);
		// String versionUpdate = props.getProperty("url_version_update", null);
		// String memberApi = props.getProperty("url_member_api", null);
		// InfoFile_ infoFile = new InfoFile_(context);
		// 将服务器地址保存在本地
		// infoFile.edit().
		// urlCenterWs().put(String.format(centerWs, serverIp)).
		// urlPayWs().put(String.format(payWs, serverIp)).
		// urlBPNServer().put(String.format(bpnServer, serverIp)).
		// urlAlipayNotify().put(String.format(alipayNotify, serverIp)).
		// urlVersionUpdate().put(versionUpdate).
		// urlMemberApi().put(String.format(memberApi, serverIp)).
		// apply();
