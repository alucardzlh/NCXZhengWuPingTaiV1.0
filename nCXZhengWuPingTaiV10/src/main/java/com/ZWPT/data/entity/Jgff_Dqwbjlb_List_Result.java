 ...
 * 
 */
public class Jgff_Dqwbjlb_List_Result {

	private String id;
	public String applyname; // 申请人姓名
	public String fwsx_name; // 服务事项名
	public String fwsx_id; // 服务事项id
	public String sldjdd; // 受理登记地点
	public String shenqing_date; // 申请日期
	public String banjie_date; // 办结期限
	public String chaoshi_date;// 超时天数
	public String ywlsh; // 业务流水号
	public String blzt; // 办理状态
	...
	public String getSldjdd() {
		return sldjdd;
	}

	public void setSldjdd(String sldjdd) {
		this.sldjdd = sldjdd;
	}
	...
	public void setChaoshi_date(String chaoshi_date) {
		this.chaoshi_date = chaoshi_date;
	}
