...
public class WheelMain {
	...
	private OnChangeListener onchangerlistener;
	...
	public void initDateTimePicker(int year, int month, int day, int h, int m,
		...
		OnWheelChangedListener wheelListener_year = new OnWheelChangedListener() {
			public void onChanged(WheelView wheel, int oldValue, int newValue) {
				...
				onchangerlistener.change(getTime());
			}
		};
		// 添加"�?监听
	...
	public OnChangeListener getOnchangerlistener() {
		return onchangerlistener;
	}
